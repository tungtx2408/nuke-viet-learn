...
if (!nv_function_exists('nv_news_block_news')) {
    ...
    function nv_news_block_news($block_config, $mod_data)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/news/block_slideshow.tpl')) {
            $block_theme = $module_info['template'];
        } else {
            $block_theme = 'default';
        }
        $xtpl = new XTemplate('block_slideshow.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/news');
        ...
        foreach ($array_block_news as $array_news) {
            ...
            $xtpl->assign('blockslideshow', $array_news);
